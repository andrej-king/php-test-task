...
(
	...
	walletStatus TINYINT(1) DEFAULT 0,
...
INSERT INTO user (login, name, password, gender, birthday, status)
...
SELECT u.id, u.name, uw.userBalance, c.currencyName, uw.walletStatus FROM user_wallets as uw
